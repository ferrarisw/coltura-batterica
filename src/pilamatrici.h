 ...
 * La classe PilaMatrici si occupa della parte algoritmica e computazionale.
 * 
 ...
 *      - Una struttura Matrix che e' la struttura dati fondamentale del
 *          di tutto il programma
 *      - Le dimensioni della matrice e il possibile stato delle cellule
 *      - Tre puntatori alla testa, coda e posizione attuale nella lista
 *      - Funzione creaMatrice, che inizializza una nuova matrice vuota
 *      - Funzione inizializza che azzera tutta la tabella
 *      - Funzione riempiCasuale che genera una configurazione casuale di
 *          cellule, vive o morte.
 *      - Funzione inizializzaCasella che setta il valore di una cellula
 *          il particolare
 *      - Funzione getValore che ritorna il valore di una cellula
 *      - Funzione contaCelluleVive che garantisce le funzionalita' statistiche
 *      - Funzione verificaMatriciUguali che confronta due matrici
 *      - Funzione patternModeSelector che seleziona il pattern da applicare
 *          alla matrice all'avvio del programma.
 * 
 */
